...
;
async function GET() {
    const directoryPath = process.env.MD_SOURCE_DIR || __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), '../'); // Use env var or default
    try {
        const files = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readdirSync(directoryPath);
        const mdFiles = files.filter((file)=>file.endsWith('.md')).map((file)=>{
            const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(directoryPath, file);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(mdFiles);
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1da802._.js.map